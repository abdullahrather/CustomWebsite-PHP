    ...
    var G = /:[0-9]+$/,
        J = function (a, b) {
            ...
            "port" === b
                ...
                : "host" === b && (a.hostname = (a.hostname || B.location.hostname).replace(G, "").toLowerCase());
            return I(a, b);
        },
        I = function (a, b, c) {
            var d = H(a.protocol);
...
(function () {
    ...
    var bd = function (a) {
        ...
        ge = function (a, b, c) {
            1 <= 100 * Math.random() ||
                G("?") ||
                ((a = ["t=error", "_e=" + a, "_v=j99", "sr=1"]), b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua));
        };
    var qc = function () {
