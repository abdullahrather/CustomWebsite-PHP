...
<p>&nbsp;</p>
            ...
            <!--item1-->
                    ...
                    <div class="col-sm-7 desc_feature">
                        <h5><p><span style="color:#059CD1;"><strong>GET A QUOTE</strong></span></p>
</h5>
                        <p><p><span style="font-size:16px;">Getting a quote for you, your family or your business is quick and easy</span></p>
</p>
                    ...
                    <div class="col-sm-7 desc_feature">
                        <h5><p><span style="color:#059CD1;"><strong>OUR PREMIUMS</strong></span></p>
</h5>
                        <p><p><span style="font-size:16px;">View our full list of affordable premiums here</span></p>
</p>
                    ...
                    <div class="col-sm-7 desc_feature">
                        <h5></h5>
                        <p><p><span style="font-size:16px;">The Surgery Only Plan covers you should you need surgery or a procedure approved by us. You will save on the premium but will&nbsp;need to fund any outpatient costs yourself</span>.</p>
</p>
                    ...
                    <div class="col-sm-7 desc_feature">
                        <h5></h5>
                        <p><p><span style="font-size:16px;">The Outpatients and Surgery Plan covers you for approved surgical procedures as well as outpatient diagnosis and consultations.​</span></p>
</p>
                    ...
                    <div class="col-sm-7 desc_feature">
                        <h5></h5>
                        <p><p><span style="font-size:16px;">Cancer Benefit is an optional addition to&nbsp;your policy provides a </span><span style="font-size:16px;">one-off</span><span style="font-size:16px;"> payment to you should you develop cancer</span></p>
</p>
                    ...
                    <div class="col-sm-7 desc_feature">
                        <h5></h5>
                        <p><p><span style="color:#000000;"><span style="font-size:16px;">With our Membership Benefits we can provide consultant support when you are ill as well as concessions on health assessments.</span></span></p>
</p>
    ...
    <div id="service">
        ...
        <div class="col-md-7 service-wrapper">
            ...
            <ul>
                <li>Breast surgery</li><li>Hip surgery</li><li>Cardiology</li><li>Knee surgery</li><li>Cardiothoracic surgery</li><li>Neurology</li><li>Colorectal surgery</li><li>Ophthalmology</li><li>Dermatology</li><li>Paediatric ear, nose and throat</li><li>Ear, nose and throat surgery</li><li>Paediatrics</li><li>Foot and ankle surgery</li><li>Paediatric surgery (over 2s)</li><li>Gastroenterology</li><li>Rheumatology</li><li>General medicine</li><li>Shoulder and elbow surgery</li><li>Liver, gall bladder surgery</li><li>Spinal orthopaedic surgery</li><li>General surgery</li><li>Upper gastrointestinal surgery</li><li>Gynaecology</li><li>Urology</li><li>Hand and wrist surgery</li><li>Vascular surgery</li>            </ul>
        </div>
        <!--//services-->
        <!--contact-->
